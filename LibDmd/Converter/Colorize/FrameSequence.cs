...
namespace LibDmd.Converter.Colorize
{
	...
	public class FrameSequence
	{
		...
		public FrameSequence(BinaryReader reader)
		{
		...
		public bool Equals(FrameSequence animation)
		{
		...
		public static FrameSequence Find(FrameSequence[] animations, long offset)
		{
			// TODO index bruichä
		...
		/// <returns></returns>
		public static FrameSequence[] ReadFrameSequence(string filename)
		{
			...
			var animations = new FrameSequence[numAnimations];
