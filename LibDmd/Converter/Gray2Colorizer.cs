...
namespace LibDmd.Converter
{
	...
	public class Gray2Colorizer : AbstractColorizer, IConverter, IColoredGray2Source, IColoredGray4Source
	{
		...
		public Gray2Colorizer(Coloring coloring, FrameSequence[] fsq = null) : base(coloring, fsq)
		{
		}

		public Gray2Colorizer(Coloring coloring, AnimationSet vni) : base(coloring, vni)
		{
		}
